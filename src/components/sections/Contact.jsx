...
export default function Contact({ id }) {
  return (
    <section id={id} className="contact-section" aria-labelledby="contact-title">
      <div className="container">
        ...
        >
          <h2 id="contact-title" className="contact-headline">
            Have a space worth imagining?
          </h2>
          <a href="mailto:info.vaastavya@gmail.com" className="contact-cta">
            <span className="contact-cta-label">Start a Project</span>
            <svg className="contact-cta-arrow" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
      ...
      <style>{`
        ...
        .contact-cta:focus-visible {
          outline: 2px solid var(--color-warm-white);
          outline-offset: 4px;
        }
        .contact-cta-arrow {
        ...
        .contact-link {
          ...
          text-decoration-color: rgba(250,249,246,0.35);
          text-underline-offset: 3px;
          transition: text-decoration-color var(--transition-fast);
        }
        .contact-link:hover {
          text-decoration-color: var(--color-warm-white);
        }
        .contact-map-link {
          ...
          color: var(--color-warm-white);
          text-decoration: none;
          border-bottom: 1px solid rgba(250,249,246,0.35);
          padding-bottom: 2px;
